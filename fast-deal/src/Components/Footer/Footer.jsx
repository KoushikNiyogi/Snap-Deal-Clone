...
export default function Footer() {
  return (
    <DIV>
      ...
      {/* -----about---- */}
      <div className="about">
        <h2>ABOUT FASTDEAL</h2>
        <p>
        FastDeal is India's leading pure-play value Ecommerce platform.
          Founded in 2023 by Koushik Niyogi, Prabhat kumar, Rajesh Pradhan, Akash Chaurasiya, Prajit Santra FastDeal is one of the
          top four online lifestyle shopping destinations of India. FastDeal
          brings together a wide assortment of good quality and value- priced
          merchandise on its platform. FastDeal's vision is to enable the
          ...
          multilingual interface and cutting edge technology, FastDeal has
          ...
          price-conscious buyers coming from the non-metros, FastDeal’s
          ...
          towns and cities and expanding. Further, FastDeal's mission is to
          ...
          to online shopping journey. FastDeal is part of the AceVector Group
      ...
      <div className="copyright">
        <h2>Copyright © 2023, FastDeal Limited. All Rights Reserved</h2>
        <h3>
