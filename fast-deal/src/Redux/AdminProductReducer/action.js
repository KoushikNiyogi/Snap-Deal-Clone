...
export const addData = (data) => async(dispatch) => {
    ...
    await axios
    .post("https://tan-jolly-dolphin.cyclic.app/products", data)
    .then(() => {
...
export const getProducts = (paramObj) => async(dispatch) => {
    ...
    await axios.get("https://tan-jolly-dolphin.cyclic.app/products", paramObj)
    .then((res)=>{
...
export const editProduct = (dataObj, id) => async(dispatch) => {
    ...
    await axios
    .patch(`https://tan-jolly-dolphin.cyclic.app/products/${id}`, dataObj)
    .then(() => {
